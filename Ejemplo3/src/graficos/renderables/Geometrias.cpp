...
Maya Primitivos::BillBoardBasico(float escala) {
...
Maya Primitivos::Esfera(int stacks, int slices, float radio, float inicio, float final) {
	//Cargamos la estructura con los espacios de memoria necesarios
...
Maya Primitivos::Plano(int vertx, int vertz, float anchof, float profz) {
	//Cargamos la estructura con los espacios de memoria necesarios
...
Maya Primitivos::Plano(int vertx, int vertz, float anchof, float profz, unsigned char* altura, float tile) {
	//Cargamos la estructura con los espacios de memoria necesarios
	Vertices* verticesxyzSD = new Vertices[vertx * vertz];
	unsigned int* indices = new unsigned int[(vertx - 1) * (vertz - 1) * 6];
	cantVert = vertx * vertz;
